...
clone : 
	git clone https://github.com/42-ping-pong/ping-pong_front.git front/app 2> /dev/null || true
	git clone https://github.com/42-ping-pong/ping_pong_back.git  back/app 2> /dev/null || true
